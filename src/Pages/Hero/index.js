  ...
  return (
    <>
      <div id='HeroSectionScroll' className={`min-h-[616px] ${color}  pt-28 xl:pt-40`}>
        <div className={`px-4 py-8 max-w-[1276px] ${color} mx-auto`}>
          <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-y-10 items-stretch">
            ...
            {/* <div class="absolute -z-10 h-full w-full bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:3rem_2rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div> */}
